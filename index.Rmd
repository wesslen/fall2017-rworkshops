...
R has become an important tool for statisticians, data scientists and (now) computational social scientists. 
...
Participants new to R should attend the first three workshops that cover essential skills in R.
...
Consulting hours will be walk-in for now (although, please email me to reserve times). 

We're working on redesigning the Project Mosaic consultation reservation website 

# Series structure

Each session will be divided into three blocks: an introduction to R (R Essentials), intermediate R skills and computational social science tools. 
...
The first three sessions assumes no knowledge of R or programming skills. 

Later sessions will assume knowledge of probability and linear regression
...
We will also use [RStudio](https://www.rstudio.com/), which is an easy-to-use interface to R. 
...
The source for the materials of this course is on GitHub at <a href="https://github.com/wesslen/Fall-2017-R-Workshop-Series">wesslen/Fall-2017-R-Workshop-Series</a>

# Feedback

If you have any feedback on the course or find any typos or errors in this website go to [issues](https://github.com/wesslen/Fall-2017-R-Workshop-Series/issues), click on the "New Issue" button to create a new issue, and add your suggestion or describe the problem.
