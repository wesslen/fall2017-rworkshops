...
Participants should bring their own laptops (if they want to run the code) with R/R Studio installed. See instructions below for details on how to get R/R Studio on your laptop.
...
The design and a lot of content of this course is based on materials by [Pablo Barberá](http://pablobarbera.com/).

For advanced users, I strongly recommend his [Fall 2017 USC Measurement Models and Statistical Computing Course](https://github.com/pablobarbera/POIR613) or Benjamin Soltoff's [U of Chicago Computing for the Social Sciences Course](http://cfss.uchicago.edu/index.html). 

His materials referenced work from:
...
The layout for this website was designed by [Jeffrey Arnold](http://www.jrnold.me/).
